                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-sm-4 centra">
                                 <h4 class="header-title m-t-0 m-b-20">Comapniess List</h4>
                            </div>
                                    ...
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <#if companiesList?has_content>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="/home"><button class="btn btn-primary btn-lg btnintlistdetails" data-target="">See Details...</button></a>
                                              </td>
                                          </tr>
                                          </#list>
                                        </#if>
