                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 centra">
                                        <i>Download this document to <ins>SIGN IT</ins> and <ins>STAMP IT</ins> in the appropriate fields.</i>
                                    </div>                                    
                                </div>
...
<br><br><br><br><br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 centra">
                                        <i>Be sure to upload the document only after it has been properly <ins>SIGNED</ins> and <ins>STAMPED</ins>.</i>
                                    </div>                                    
                                </div>
...
<br><br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3"></div>
                                    <form action="viewDocumentation?action=upload&student_id=${student_id}&internship_id=${internship_id}" method ="post" enctype="multipart/form-data">
                                        <div class="centra">
