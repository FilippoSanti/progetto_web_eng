                        ...
                        <#if errorMessage?has_content >
                            ...
                            <div class="m-t-40 card-box">
                                ...
                                <div class="account-content">
                                    ...
                                    <form class="form-horizontal" method="post" action="resetPassword?submit=true">

                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                                <label for="emailaddress">Email address</label>
                                                <input class="form-control" name="email" type="email" id="emailaddress" required="" placeholder="Enter E-mail Address Here">
                                            </div>
                                        </div>
