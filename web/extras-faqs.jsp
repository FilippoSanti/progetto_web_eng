                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="text-center">
                                                <h4 class="font-600">Frequently Asked Questions</h4>
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-5 offset-md-1">
                                            <div class="p-20">
                                                <!-- Question/Answer -->
                                                <div class="m-b-30">
                                                    <h6 class="question font-14">What is Lorem Ipsum?</h6>
                                                ...
                                                <div class="m-b-30">
                                                    <h6 class="question font-14">Why use Lorem Ipsum?</h6>
                                                ...
                                                <div class="m-b-30">
                                                    <h6 class="question font-14">How many variations exist?</h6>
                                                    <p class="answer">Lorem Ipsum is simply dummy text of the printing
                                                        and typesetting industry. Lorem Ipsum has been the industry's
                                                        standard dummy text ever since the 1500s.</p>
                                                </div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="p-20">
                                                <!-- Question/Answer -->
                                                <div class="m-b-30">
                                                    <h6 class="question font-14">Is safe use Lorem Ipsum?</h6>
                                                    <p class="answer">Lorem Ipsum is simply dummy text of the printing
                                                        and typesetting industry. Lorem Ipsum has been the industry's
                                                        standard dummy text ever since the 1500s.</p>
                                                </div>
                                                ...
                                                <div class="m-b-30">
                                                    <h6 class="question font-14">When can be used?</h6>
                                                    <p class="answer">Lorem ipsum dolor sit amet, in mea nonumes
                                                        dissentias dissentiunt, pro te solet oratio iriure. Cu sit
                                                        consetetur moderatius intellegam, ius decore accusamus te. Ne
                                                        primis suavitate disputando nam. Mutat convenirete.</p>
                                                ...
                                                <div class="m-b-30">
                                                    <h6 class="question font-14">License &amp; Copyright</h6>
                                                    <p class="answer">Lorem Ipsum is simply dummy text of the printing
                                                        and typesetting industry. Lorem Ipsum has been the industry's
                                                        standard dummy text ever since the 1500s.</p>
                                                </div>
