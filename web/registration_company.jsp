                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                                ...
                                                <input type="text" name="Degree Course" parsley-trigger="change" required
                            ...
                            <div class="form-group">
                                                ...
                                                <input id="pass3" type="password" placeholder="Password" required
                                                       class="form-control">
                                            </div>
                               ...
                               <div class="p-20 m-b-20">
                                    ...
                                    <div class="m-b-20">
                                        ...
                                        <option value="VT">Viterbo</option>
                                            ...
                                            <div class="form-group">
                                                <label for="solicitorSurname">Cognome Rappresentante Legale<span class="text-danger">*</span></label>
                                                <input type="text" name="solicitorSurname" parsley-trigger="change" required
                                                       placeholder="Enter Solicitor's Surname" class="form-control" id="solicitorSurname">
                                            </div>

                                            <div class="form-group">
                                                <label for="managerSurname">Cognome Responsabile Tirocini<span class="text-danger">*</span></label>
                                                <input type="text" name="managerSurname" parsley-trigger="change" required
                                                       placeholder="Enter Internships Manager's Surname" class="form-control" id="managerSurname">
                                            </div>

                                            <div class="form-group">
                                                <label for="managerEmail">E-mail Responsabile Tirocini<span class="text-danger">*</span></label>
                                                <input type="text" name="managerEmail" parsley-trigger="change" required
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="pass4" type="password" placeholder="Ripeti Password" required
                                                       class="form-control">
                                            </div>
