                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                               <div class="p-20 m-b-20">
                                    ...
                                    <div class="m-b-20">
                                        <form action="#" class="form-validation">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nome" parsley-trigger="change" required
                                                       placeholder="Enter Name" class="form-control" id="nome">
                                            </div>

                                            <div class="form-group">
                                              <label>Data di Nascita<span class="text-danger">*</span><a>  (usare il formato: mese/giorno/anno)</a></label>
                                        ...
                                        <div class="form-group" name="provincia_nascita" id="provincia_nascita">
                                        ...
                                        <div class="form-group">
                                                <label for="residenza">Indirizzo di Residenza<span class="text-danger">*</span></label>
                                                <input type="text" name="residenza" parsley-trigger="change" required
                                                       placeholder="Enter Address" class="form-control" id="residenza">
                                            </div>

                                        <div class="form-group" name = "provincia" id="provincia">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="telephone" parsley-trigger="change" required
                                                       placeholder="Enter Telephone Number" class="form-control" id="telefono">
                                            </div>

                                          <div class="form-group">
                                                <label for="corso_laurea">Corso di Laurea<span class="text-danger">*</span></label>
                                                <input type="text" name="corso_laurea" parsley-trigger="change" required
                                                       placeholder="Enter Degree Course" class="form-control" id="corso_laurea">
                                            </div>
                                        ...
                                        <form action="#" class="form-validation">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="cognome" parsley-trigger="change" required
                                                       placeholder="Enter Surname" class="form-control" id="cognome">
                                            </div>
                                            ...
                                            <div class="form-group rippwd4">
                                                ...
                                                <input id="pass2" type="repeat password" placeholder="Repeat Password" required
                                                       class="form-control">
                                            </div>
                            ...
                            <form method="post" action="registration_student">
                                <div class="row">
                                    <div class="form-group formspace">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light" name="registration_student"
                                                value="registration_student">
                                            Register
                                        </button>
                                        <button type="reset"
