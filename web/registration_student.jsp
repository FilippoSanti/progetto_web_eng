    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <form method="post" action="registration_student" class="form-validation">
                ...
                <div class="row">
                        ...
                        <div class="p-20 m-b-20">
                            ...
                            <div class="m-b-20">
                                    ...
                                    <div class="form-group rippwd4">
                                        ...
                                        <input id="pass2" name="ripeti_password" type="repeat password" placeholder="Repeat Password" required
                                               class="form-control">
                                    </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group formspace">
                            <button type="submit" name="registration_student" class="btn btn-primary waves-effect waves-light">
                                Register
                            </button>
                            <button type="reset"
