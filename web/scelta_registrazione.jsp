                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" action="#">
                                        ...
                                        <div class="form-group metismenu styleregchoose">
                                            <li class="container"> 
                            <a href="WEB-INF/views/registration_student.ftl"><i class="sceltaregistrazione1 ti-pencil-alt"></i><span class="sceltaregistrazione"> Form Registrazione Studenti </span>
                             </a>
                        </li>
                                        </div>
